export const nfts2meABI = [
    ...
    {
        inputs: [],
        name: 'CantRevealYetWaitABitToBeAbleToRedeem',
        type: 'error',
    },
    {
        inputs: [],
        name: 'CantSetBaseURIAndPlaceholderAtTheSameTime',
        type: 'error',
    },
    {
        inputs: [],
    ...
    {
        inputs: [],
        name: 'ContractMetadataURIAlreadyFixed',
        type: 'error',
    },
    {
        inputs: [],
        name: 'InputSizeMismatch',
        type: 'error',
    },
    {
        inputs: [],
    ...
    {
        inputs: [],
        name: 'InvalidMintFeeForFreeMinting',
        type: 'error',
    },
    {
        inputs: [],
    ...
    {
        inputs: [],
        name: 'NewPlaceholderCantBeEmpty',
        type: 'error',
    },
    {
        inputs: [],
        name: 'NoBaseURINorPlaceholderSet',
        type: 'error',
    },
    {
        inputs: [],
    ...
    {
        inputs: [],
        name: 'TotalSupplyMustBeGreaterThanZero',
        type: 'error',
    },
    {
        inputs: [],
    ...
    },
    {
        inputs: [
            ...
            },
            {
                ...
                internalType: 'struct IN2M_ERCStorage.RevenueAddress[]',
                name: 'revenueAddresses',
                type: 'tuple[]',
            },
            {
                internalType: 'address',
                name: 'iErc20PaymentAddress',
                type: 'address',
            },
            {
                internalType: 'uint32',
            ...
            {
                internalType: 'enum IN2M_ERCStorage.MintingType',
                name: 'iMintingType',
                type: 'uint8',
            },
        ],
